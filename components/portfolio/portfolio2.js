...
import WorkItem2 from "../work/item_2";
...
function Portfolio2() {
    ...
    return (
        <div className="portfolio_2 setup__component">
            <div className="container-fluid">
                ...
                <div className="portfolio__list row" ref={filterRef}>
                    {worklist.map((e, i) => {
                        return (
                            <div
                                className={`item__parent col-12 col-md-6 col-lg-4 ${e.filter}`}
                                key={i}>
                                <WorkItem2 data={e} index={i} />
                            </div>
                        );
                    })}
                </div>
